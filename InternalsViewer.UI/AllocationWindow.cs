...
namespace InternalsViewer.UI
{
    ...
    {
        public DataBaseEventArgs(Database db)
        {
            CurDatabase = db;
        }

        public Database CurDatabase { get; set; }
    }
    public partial class AllocationWindow : UserControl
    {
        ...
        private void DatabaseToolStripComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                DataBaseSelected(sender, new DataBaseEventArgs((Database)databaseToolStripComboBox.SelectedItem) { });
            }
        }
