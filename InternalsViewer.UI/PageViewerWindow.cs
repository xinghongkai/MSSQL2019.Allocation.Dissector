...
namespace InternalsViewer.UI
{
    public partial class PageViewerWindow : UserControl
    {
        ...
        /// 感觉这里有个bug，为什么IAM时 selectedoffset为0呢？难道是MSSQL2019的变化？
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        ...
        private void OffsetTable_SlotChanged(object sender, EventArgs e)
        {
            if (offsetTable.SelectedOffset > 0 || 
                (this.page.Header.PageType!=PageType.Data 
                &&this.page.Header.PageType!=PageType.Index 
                &&this.page.Header.PageType!=PageType.Lob3
                && this.page.Header.PageType != PageType.Lob4))
            {
